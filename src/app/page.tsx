      ...
      <main className="flex-grow relative z-10">
        ...
        <section className="relative pt-16 pb-24 md:pt-32 md:pb-48">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center text-center space-y-8 md:space-y-12 mb-20 max-w-5xl mx-auto">
            ...
            <div className="relative max-w-6xl mx-auto px-4">
              <div className="relative rounded-[2.5rem] md:rounded-[3.5rem] border border-gray-200 bg-white/80 backdrop-blur-3xl shadow-[0_40px_100px_rgba(0,0,0,0.12)] overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-24 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                  <Card className="rounded-[2rem] border-gray-100 shadow-xl p-8 hover:translate-y-[-4px] transition-transform">
